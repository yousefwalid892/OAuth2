...
* The original package name 'com.example.Resource server ' is invalid and this project uses 'com.example.Resource.server' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.1.9/reference/htmlsingle/index.html#web.security.oauth2.server)
