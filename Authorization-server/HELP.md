...
* The original package name 'com.example.Authorization server ' is invalid and this project uses 'com.example.Authorization.server' instead.
...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/docs/3.1.9/reference/htmlsingle/index.html#web.security.oauth2.authorization-server)
